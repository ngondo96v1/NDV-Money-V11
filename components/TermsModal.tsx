  ...
  return (
    <div className="fixed inset-0 z-[2000] bg-black flex flex-col h-[100dvh] max-w-md mx-auto animate-in fade-in duration-300 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
        ...
        <div className="bg-[#ff8c00]/5 border border-[#ff8c00]/10 rounded-2xl p-5">
          <p className="text-[10px] font-bold text-[#ff8c00] text-center italic">
      ...
      {/* Footer */}
      <div className="p-6 border-t border-white/5 shrink-0 bg-black pb-8">
        <button 
          onClick={onClose}
          className="w-full py-4.5 bg-[#ff8c00] text-black font-black text-[11px] uppercase tracking-[0.2em] rounded-2xl active:scale-95 transition-all shadow-xl shadow-orange-950/20"
        >
